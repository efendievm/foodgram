# Generated by Django 3.2.3 on 2024-07-06 21:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='recipe',
            name='favorited',
            field=models.ManyToManyField(related_name='favorited_recipes', through='recipes.UserFavoriteRecipes', to=settings.AUTH_USER_MODEL, verbose_name='В списке избранного пользователей'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='ingredients',
        ...
        migrations.AddField(
            model_name='recipe',
            name='shopping_cart',
            field=models.ManyToManyField(related_name='recipes_in_shopping_cart', through='recipes.UserShoppingCart', to=settings.AUTH_USER_MODEL, verbose_name='В списке покупок пользователей'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='tags',
